...
class NeonGolf {
    ...
    gameOver(won) {
        ...
        if (won) {
            ...
            // Draft shameful email to the boss...
            this.draftFailureEmail();
        }
    ...
    draftFailureEmail() {
        ...
        setTimeout(() => {
            ...
            const subject = 'URGENT: EMPLOYEE MINI-GOLF PERFORMANCE REPORT';
            const body = `ATTENTION JEFFREY JENKINS,

YOUR SUBORDINATE HAS FAILED THE MINI-GOLF GAME AND HAS CODE STILL UNCOMMITTED.
...
---
Game Stats:
- Strokes Used: ${this.strokes}/${this.maxStrokes}
- Par: ${this.par}
- Result: FAILURE
- Timestamp: ${new Date().toLocaleString()}

This email was automatically generated by NEON GOLF '85.`;
            ...
            statusEl.textContent = '📧 DRAFTING FAILURE REPORT TO JEFFREY JENKINS... 📧';
            statusEl.style.color = '#ff6600';
            statusEl.style.textShadow = '0 0 15px #ff6600';
